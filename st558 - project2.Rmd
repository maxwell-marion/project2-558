...
### Boxplot of the Number of Keywords vs. Share Category (Above 1,400 or Below 1,400)

```{r}
# Creating a boxplot of num keywords vs share category
count_box <- ggplot(newsTrain, aes(x = SharesClass, y = num_keywords))
count_box + geom_boxplot() + 
  labs(title = "Keyword Count Boxplots By Share Category", 
       x = "Share Count", y = "Keyword Count")
...
(ADDING A SHORT EXPLANATION OF THE IDEA BEHIND A LINEAR REGRESSION MODEL HERE)
